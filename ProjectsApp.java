...
public class ProjectsApp {
	...
	//@formatter:off
		...
		private void updateProjectDetails() throws Exception {
			...
			Integer difficulty = getIntInput("Enter the project diffeculty (1-5) [" + curProject.getDifficulty()+ "]");
		...
		private void selectProject() throws Exception {
			listProjects();
		...
		private void createProject() {
				...
				Integer difficulty = getIntInput("Enter the project diffeculty (1-5)");
